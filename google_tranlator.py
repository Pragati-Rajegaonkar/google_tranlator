...
#icon
image_icon=PhotoImage(file="g2.png")
root.iconphoto(False,image_icon)


#arrow
arrow_image=PhotoImage(file="a22.png")
...
#translate button
translate=Button(root,text="Translate",font=("Roboto",15),activebackground="white",cursor="hand2",bd=1,width=10,height=2,bg="red"
